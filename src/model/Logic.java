...
public class Logic extends PApplet {
	...
	public Logic(PApplet app) {
		...
		this.app = app;
		circle = new Circle(50, 50, 50, 1, 1, 255, 0, 255, app);
		square = new Square(50, 50, 50, 1, 1, 255, 0, 255, app);
	...
	public void setup() {
		...
		int posX = (int) random(0,780);
		int posY = (int) random(0,780);
		int dirX=1;
		int dirY=1;
		...
		case 0:
			...
			figure.add(new Circle(tam, posX, posY, dirX, dirY, r, g, b, app));
			
			break;
		
		case 1:
			
			figure.add(new Square(tam, posX, posY, dirX, dirY, r, g, b, app));
